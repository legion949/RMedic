...
Graficos2C_08_Conectores_UI <- function(id) {
...
## Segmento del server
Graficos2C_08_Conectores_SERVER <- function(input, output, session, 
                                            minibase, 
                                            decimales,
                                            control_ejecucion) {
  ...
  output$grafico01 <- renderPlot({
    ...
    graficos_2c(minibase = minibase(), 
                tipo_grafico = "conectores", # conectores
